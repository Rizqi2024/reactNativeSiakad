...
export default function Mahasiswa() {
    ...
    <View style={styles.container}>
        ...
        <TextInput placeholder="NIM" style={styles.input} value={nim} onChangeText={setNim}/>
        <TextInput placeholder="Nama Mahasiswa" style={styles.input} value={nama} onChangeText={setNama}/>
        ...
        <FlatList data={data} keyExtractor={(item,index)=>index.toString()} renderItem={({item,index})=>(
            <View style={styles.tableRow}>
                ...
                <View style={styles.action}>
                    <TouchableOpacity style={styles.edit} onPress={()=>editData(index)}>
                    <Text style={styles.textButton}>Edit</Text>
                    </TouchableOpacity><TouchableOpacity style={styles.delete} onPress={()=>hapusData(index)}>
